...
5. **Современные архитектуры глубокого обучения.** Обзор современных архитектур, включая семейства трансформеров. Применение данных архитектур для анализа последовательных данных, изображений.
...
5. **Работа с последовательными данными.** Применение современных архитектур (трансформеров) для анализа последовательных данных.
