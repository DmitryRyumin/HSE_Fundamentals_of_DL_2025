...
6. **Современные архитектуры глубокого обучения.** Обзор современных архитектур, включая семейства Mamba. Применение данных архитектур для анализа последовательных данных, изображений.
...
5. [**Работа с последовательными данными.**](https://github.com/DmitryRyumin/HSE_Fundamentals_of_DL_2025/blob/main/tutorials/4.ipynb) Применение современных архитектур (трансформеров) для анализа последовательных данных.
6. **Работа с последовательными данными.** Применение современных архитектур (Mamba) для анализа последовательных данных.
